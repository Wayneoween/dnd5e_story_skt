...
{% include glossary_link.html title="Bale" name="Bale Farnsworth Havensack Udeer" %} dem Schmied aus dem
...
Wegen dem wichtigen Auktionstermin in {% include glossary_link.html title="Goldenfields" %} wollten wir für die uns bis
